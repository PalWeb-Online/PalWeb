...
import {useRecordStore} from '../store/useRecordStore'; // Store for handling records
...
const moveForward = () => {
    console.log('Move forward to next word');
    // Logic to move to the next word in the list
};
