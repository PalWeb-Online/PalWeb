...
<template>
    <div class="wiki-content-block">
        ...
        <div class="wiki-chart" style="grid-template-columns: repeat(3, 1fr);">
            <div>NAME</div><div>LETTER</div><div>VOWEL</div>
            <div>fatħa (فتحة)</div><div>ــَـ</div><div>/a/ (short open-front)</div>
            <div>kasra (كسرى)</div><div>ــِـ</div><div>/i/ (short closed-front)</div>
            <div>ḍamme (ضمّة)</div><div>ــُـ</div><div>/u/ (short closed-back)</div>
            <div>ʔalf (ألف)</div><div>ا</div><div>/aː/ (long open-front)</div>
            <div>yā (يا)</div><div>ي</div><div>/iː/ (long closed-front)</div>
            <div>wāw (واو)</div><div>و</div><div>/uː/ (long closed-back)</div>
        </div>
        ...
        <p>Now is a good time to mention that the consonant <b>/r/</b> is usually pharyngealized as well.
            Additionally, the consonant <b>/q/</b> produces <b>[ɑ]</b> as well. However, as we saw in <b>Lesson 5</b>,
            this pronunciation is borrowed from Standard Arabic, whereas none of the native pronunciations of this
            letter have this effect.</p>
...
<!--        </x-vocabulary>-->
        ...
        <p>Since there's no unique way to write the short and long <b>/e/</b> and <b>/o/</b> vowels, short and long
            <b>/e/</b>
            is written as short and long <b>/i/</b>, while short and long <b>/o/</b> is written as short and long
            <b>/u/</b>.
        </p>

        <p>However, short and long <b>/e/</b> & <b>/o/</b> arise in very specific circumstances. While short <b>/e/</b>
            only
            exists as the pronunciation of <b>ta marbūṭa (ة)</b>, short <b>/o/</b> only exists as the <b>3M</b> personal
            suffix.
            In fact, speakers who pronounce <b>ta marbūṭa</b> as <b>/a/</b> have no short <b>/e/</b> vowel phoneme at
            all.
            Meanwhile, long <b>/e/</b> and <b>/o/</b> specifically appear as a way of "flattening" the sequences
            <b>/aj/</b> & <b>/aw/</b>. Similarly, <b>/e:/</b> can sometimes arise in place of a <b>ya hamza (ئ)</b>, as
            in
            <a
                href="https://www.wiktionary.org/wiki/حيط#South_Levantine_Arabic" target="_blank">حيط</a> <b>(ħēṭ)</b> &
            <a
                href="https://www.wiktionary.org/wiki/عيلة#South_Levantine_Arabic" target="_blank">عيلة</a>
            <b>(3ēle)</b>
            (see
            <b>Lesson X</b>).</p>

        <div class="wiki-chart" style="grid-template-columns: repeat(3, 1fr)">
            <div>TERM</div><div>STANDARD</div><div>SPOKEN (URBAN)</div>
            <Link :href="route('terms.show', 'noun-bēt')">بَيْت</Link><div>/bajt/ (bayt)</div><div>/beːt/ (bēt)</div>
            <Link :href="route('terms.show', 'noun-lēl')">لَيْل</Link><div>/lajl/ (layl)</div><div>/leːl/ (lēl)</div>
            <Link :href="route('terms.show', 'noun-ṣēf')">صَيْف</Link><div>/sˤajf/ (ṣayf)</div><div>/sˤeːf/ (ṣēf)</div>
            <Link :href="route('terms.show', 'noun-yōm')">يَوْم</Link><div>/yawm/ (yawm)</div><div>/yoːm/ (yōm)</div>
            <Link :href="route('terms.show', 'noun-fōʔ')">فَوْق</Link><div>/fawq/ (fawq)</div><div>/foːʔ/ (fōʔ)</div>
            <Link :href="route('terms.show', 'noun-žōz')">جَوْز</Link><div>/dʒawz/ (jawz)</div><div>/ʒoːz/ (žōz)</div>
        </div>
        ...
        <p>As for <b>/o:/</b>, some speakers pronounce the <b>1S</b> & <b>3M</b> forms of the <b>Present Tense</b> of
            hamze-initial terms (namely, <a href="https://www.wiktionary.org/wiki/أكل#South_Levantine_Arabic"
                                            target="_blank">أكل</a>
            & <a href="https://www.wiktionary.org/wiki/أخد#South_Levantine_Arabic" target="_blank">أخد</a>) with
            <b>/o:/</b>
            —
        ...
        <p>How do we know when and how to pronounce every vowel? After all, in writing there are still just three vowel
            letters
            & three short vowel marks. As we’re about to see, some of these vowels only occur in specific settings and
            their
            pronunciation is affected by other things going on in the word.</p>

        <p>Be aware that the <b>vowel inventory</b> we have created is a list of the vowel <b>phonemes</b> of
            Palestinian
            Arabic; this is not necessarily how they are pronounced in reality. For instance, the original <b>/i/</b> &
            <b>/u/</b> short vowels are generally not as tense in the dialect; they sound like <b>[ɪ]</b> & <b>[ʊ]</b>,
            but
            may
        ...
        <p>Additionally, long vowels are frequently shortened as an outcome of alternations caused by word stress (see
            <b>Lesson
                8</b>). When this happens, the original quality of the vowel remains intact. This can create instances
            of
            short
            <b>[e]</b> and <b>[o]</b>, although they are “officially” <b>/e:/</b> and <b>/o:/</b>; long <b>/i:/</b> &
            <b>/u:/</b> shortened by this process will sound more tense than their short counterparts would otherwise be
            as
            well.</p>
        ...
        <p>Additionally, <b>ta marbūṭa</b> is pronounced as <b>[a]</b> around the following consonants that are
            pronounced
            at
...
<!--        <p>And that’s everything you need to know about <b>Vowels</b> in Palestinian Arabic. The purpose of this lesson-->
<!--            is-->
<!--            not-->
<!--            to strictly memorize these rules, but to keep these ideas in mind as you continue to learn the dialect;-->
<!--            these-->
<!--            are-->
<!--            all very subtle differences that you're not going to consciously & consistently pull off just by memorizing-->
<!--            the-->
<!--            rules for them. It's also so that you can get a better idea of how a word in writing should be pronounced,-->
<!--            even-->
<!--            if-->
