<x-vue.deck component="DeckContainer" :deck="\App\Models\Deck::find(46)"/>
...
<x-lesson-concept section-type="skill" section-title="grammar"
    ...
    <x-sentence-item eng="I am going to the store">
    ...
    <x-sentence-item eng="we are leaving work">
...
<x-lesson-concept section-type="skill" section-title="vocabulary"
    ...
    <x-sentence-item eng="he is coming by bus">
        <x-sentence-term arb="هو" eng="he" :term="$terms['huwwe'] ?? null"/>
...
<x-lesson-concept section-type="idea" section-title="speak like a native"
    ...
    <x-sentence-item eng="(I) don't know where he is">
    ...
    <x-sentence-item eng="maybe he's at the office">
    ...
    <x-sentence-item eng="I guess he's at the office">
