<x-deck :deck="\App\Models\Deck::find(51)"/>
...
<x-lesson-concept section-type="idea" section-title="speak like a native"
    ...
    <x-sentence eng="tomorrow is my friend's birthday, so I need a gift for him">
