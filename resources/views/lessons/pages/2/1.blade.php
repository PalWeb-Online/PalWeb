<x-deck :deck="\App\Models\Deck::find(47)"/>
...
<x-lesson-concept section-type="skill" section-title="grammar"
    ...
    <x-sentence eng="a new white house">
    ...
    <x-sentence eng="a university professor's house">
        <x-sentence-term arb="بيت" eng="house" :term="$terms['bēt'] ?? null"/>
    ...
    <x-sentence eng="the new white house">
    ...
    <x-sentence eng="the university professor's house">
        <x-sentence-term arb="بيت" eng="house" :term="$terms['bēt'] ?? null"/>
        <x-sentence-term arb="أستاذ" eng="professor" :term="$terms['ʔustāz'] ?? null"/>
    ...
    <x-sentence eng="what is the meaning of the word 'bisse'?">
...
<x-lesson-concept section-type="skill" section-title="vocabulary"
    ...
    <x-sentence eng="I live near Jerusalem">
    ...
    <x-sentence eng="I live far from Haifa">
        <x-sentence-term arb="أنا" eng="I" :term="$terms['ʔana'] ?? null"/>
        <x-sentence-term arb="ساكن" eng="living" :term="$terms['sākin'] ?? null"/>
    ...
    <x-sentence eng="this is better than this">
    ...
    <x-sentence eng="I prefer this over this">
...
<x-lesson-concept section-type="idea" section-title="speak like a native"
    ...
    <x-sentence eng="actually, Ghassan is sick today">
    ...
    <x-sentence eng="anyway, he's not coming to class">
