<x-vue.deck component="DeckContainer" :deck="\App\Models\Deck::find(60)"/>
...
<x-lesson-concept section-type="skill" section-title="grammar"
    ...
    <x-sentence-item eng="he was in the bathroom">
    ...
    <x-sentence-item eng="the movie was nice">
    ...
    <x-sentence-item eng="I had a question">
...
<x-lesson-concept section-type="skill" section-title="vocabulary"
    ...
    <x-sentence-item eng="I didn't have many friends when I was young">
