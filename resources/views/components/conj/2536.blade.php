...
@if ($form == '2A')
    ...
    @elseif ($form == '6B')
        <x-slot name="imp1S">بت{{$r1}}ا{{$r2}}ى</x-slot>
        <x-slot name="imp1Str">bat{{$r1tr}}ā{{$r2tr}}a</x-slot>
        <x-slot name="imp1P">منت{{$r1}}ا{{$r2}}ى</x-slot>
        <x-slot name="imp1Ptr">mnit{{$r1tr}}ā{{$r2tr}}a</x-slot>
        <x-slot name="imp2F">بتت{{$r1}}ا{{$r2}}ي</x-slot>
        <x-slot name="imp2Ftr">btit{{$r1tr}}ā{{$r2tr}}i</x-slot>
        <x-slot name="imp2P">بتت{{$r1}}ا{{$r2}}و</x-slot>
        <x-slot name="imp2Ptr">btit{{$r1tr}}ā{{$r2tr}}u</x-slot>
        <x-slot name="imp3M">بت{{$r1}}ا{{$r2}}ى</x-slot>
        <x-slot name="imp3Mtr">bit{{$r1tr}}ā{{$r2tr}}a</x-slot>
        <x-slot name="imp3F">بتت{{$r1}}ا{{$r2}}ى</x-slot>
        <x-slot name="imp3Ftr">btit{{$r1tr}}ā{{$r2tr}}a</x-slot>
        <x-slot name="imp3P">بت{{$r1}}ا{{$r2}}و</x-slot>
        <x-slot name="imp3Ptr">bit{{$r1tr}}ā{{$r2tr}}u</x-slot>
...
@if ($form == '2A')
    ...
    @elseif ($form == '6B')
        <x-slot name="past1S">ت{{$r1}}ا{{$r2}}يت</x-slot>
        <x-slot name="past1Str">t{{$r1tr}}ā{{$r2tr}}ēt</x-slot>
        <x-slot name="past1P">ت{{$r1}}ا{{$r2}}ينا</x-slot>
        <x-slot name="past1Ptr">t{{$r1tr}}ā{{$r2tr}}ēna</x-slot>
        <x-slot name="past2F">ت{{$r1}}ا{{$r2}}يتي</x-slot>
        <x-slot name="past2Ftr">t{{$r1tr}}ā{{$r2tr}}ēti</x-slot>
        <x-slot name="past2P">ت{{$r1}}ا{{$r2}}يتو</x-slot>
        <x-slot name="past2Ptr">t{{$r1tr}}ā{{$r2tr}}ētu</x-slot>
        <x-slot name="past3M">ت{{$r1}}ا{{$r2}}ى</x-slot>
        <x-slot name="past3Mtr">t{{$r1tr}}ā{{$r2tr}}a</x-slot>
        <x-slot name="past3F">ت{{$r1}}ا{{$r2}}ت</x-slot>
        <x-slot name="past3Ftr">t{{$r1tr}}ā{{$r2tr}}at</x-slot>
        <x-slot name="past3P">ت{{$r1}}ا{{$r2}}و</x-slot>
        <x-slot name="past3Ptr">t{{$r1tr}}ā{{$r2tr}}u</x-slot>
...
@if ($form == '2A')
    ...
    @elseif ($form == '5B')
        ...
        <x-slot name="amr2Ftr">t{{$r1tr}}a{{$r2tr}}{{$r2tr}}i</x-slot>
    ...
    @elseif ($form == '6B')
        <x-slot name="amr2M">ت{{$r1}}ا{{$r2}}ي</x-slot>
        <x-slot name="amr2Mtr">t{{$r1tr}}ā{{$r2tr}}a</x-slot>
        <x-slot name="amr2F">ت{{$r1}}ا{{$r2}}ي</x-slot>
        <x-slot name="amr2Ftr">t{{$r1tr}}ā{{$r2tr}}i</x-slot>
        <x-slot name="amr2P">ت{{$r1}}ا{{$r2}}و</x-slot>
        <x-slot name="amr2Ptr">t{{$r1tr}}ā{{$r2tr}}u</x-slot>
