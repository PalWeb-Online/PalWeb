...
<div class="doc-section">
    ...
    <p>The <b>Curriculum</b> will expose you to essential vocabulary & covers every grammatical
        structure of the language. After that, you can use the resources in the <b>Texts</b> section of the site to
        widen
    ...
    <h2>{{ __('texts') }}</h2>
    <p>The <b>Texts</b> section is intended to follow the content of the
        <b>Lessons</b> section, that is, the formal curriculum that should take learners up to an intermediate level in
        Palestinian Arabic. Because of this, the presentation of the following texts is designed for intermediate- to
