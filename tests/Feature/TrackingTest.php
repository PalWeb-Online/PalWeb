...
class TrackingTest extends TestCase
{
     ...
     * @test
     */
    public function a_UserViewed_event_will_be_fired_off_on_every_page_view()
    {
    ...
    public function test_a_UserDeniedAccess_event_will_be_fired_off_if_user_is_denied_access_to_api_route()
    {
        Config::set('app.track_page_views', true);
