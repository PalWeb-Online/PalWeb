...
class TermRepositoryTest extends TestCase
{
    ...
    public function test_get_term_for_category_and_slug_throws_exception_if_not_a_valid_category(): void
    {
    ...
    public function test_get_term_for_category_and_slug_with_all_possible_categories(): void
    {
